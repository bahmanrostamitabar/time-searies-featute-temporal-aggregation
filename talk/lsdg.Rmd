...
---
## Submitted / Wroks in progress


- Rostami-Tabar B., Goltsos T. Wang, S. (2022), Overlapping and non-overlapping temporal aggregation: to combine or not to combine, submitted to Computers in Industry

- Rostami-Tabar B., D. Mercetic (2022), Temporal aggregation and time series features, submitted to EJOR

- Rostami-Tabar B., Harsha, M., Akhlaghi L., Athanasopoulos G. (2022), Forecasting and stock control for vaccine distribution, Target Journal: MSOM

- Rostami-Tabar B. Hyndman J. R. (2022), hierarchical count time series forecasting in emergency medicine, Target Journal: Journal of Service Research
