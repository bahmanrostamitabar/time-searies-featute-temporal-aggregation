...
knitr::kable(setup, booktabs = T, linesep = "",caption = "The main setup information for the ML models") %>% kableExtra::kable_styling(latex_options = c("hold_position"), font_size =11)
```