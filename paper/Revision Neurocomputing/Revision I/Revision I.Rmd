...
knitr::kable(setup, booktabs = T, linesep = "",caption = "The main setup information for ML models") %>% kableExtra::kable_styling(latex_options = c("scale_down","hold_position"), font_size =8) |> 
  column_spec(1,"1cm") %>% column_spec(2,"2cm")  %>%
  column_spec(3,"1cm") %>% column_spec(4,"1cm")  %>%
  column_spec(5,"6cm") %>% column_spec(6,"3cm")  %>% column_spec(7,"3cm") |> kableExtra::landscape()
