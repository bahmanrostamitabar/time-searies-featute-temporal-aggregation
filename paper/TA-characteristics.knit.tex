...
aggregation}
  ...
  \fnref{1}}
   \ead{rostami-tabarb@cardiff.ac.uk} 
    \author[University of Novi Sad Faculty of Technical Sciences]{Dejan
Mircetic%
  %
  \fnref{2}}
   \ead{DejanMircetic@uns.ac.rs} 
      \affiliation[Cardiff Business School]{Cardiff business school, 3
Colum Drive, CF10 3EU, Cardiff}
    \affiliation[University of Novi Sad Faculty of Technical
Sciences]{Faculty of Technical Sciences \& Institute for Artificial
Intelligence research and development of Serbia,Trg Dostiteja Obradovica
6, 2100 Novi Sad, Republic of Serbia}
  ...
  indivisual series. AF is shown to be significantly better than AD for
  ...
  \end{abstract}
    \begin{keyword}
    Temporal Aggregation, Forecasting, Time Series Feature, Exponential
Smoothing, Machine Learning, Random Forest, Classification \sep 
    Temporal Aggregation, Forecasting, Time Series Feature, Exponential
Smoothing, Machine Learning, Random Forest, Classification
  \end{keyword}
