...
#ovo daje najpreciznije prognoze, skoro kao RF.
```
...
# Optimal threshold
```{r}
source("cutoff_nn.R")# jedina razlika u odnosu na stadnardni cuttoff kod je sto ne max auc nego minimizujes gresku
...
* Connect to supercomputer at Artificial Intelligence Institute for faster rendering
